...
Button NLRButton(
	"NLR",
	BUTTON_WIDTH / 2,
	WINDOW_HEIGHT - BUTTON_TOP_MARGIN - BUTTON_HEIGHT - 60,
	BUTTON_WIDTH,
	BUTTON_HEIGHT,
	buttonColor,
	buttonTextColor,
...
Button NRLButton(
	"NRL",
	BUTTON_WIDTH / 2,
	WINDOW_HEIGHT - BUTTON_TOP_MARGIN - BUTTON_HEIGHT - 120,
	BUTTON_WIDTH,
	BUTTON_HEIGHT,
	buttonColor,
	buttonTextColor,
...
Button LRNButton(
	"LRN",
	BUTTON_WIDTH / 2,
	WINDOW_HEIGHT - BUTTON_TOP_MARGIN - BUTTON_HEIGHT - 180,
	BUTTON_WIDTH,
	BUTTON_HEIGHT,
	buttonColor,
	buttonTextColor,
...
Button LNRButton(
	"LNR",
	BUTTON_WIDTH / 2,
	WINDOW_HEIGHT - BUTTON_TOP_MARGIN - BUTTON_HEIGHT - 240,
	BUTTON_WIDTH,
	BUTTON_HEIGHT,
	buttonColor,
	buttonTextColor,
...
Button RLNButton(
	"RLN",
	BUTTON_WIDTH / 2,
	WINDOW_HEIGHT - BUTTON_TOP_MARGIN - BUTTON_HEIGHT - 300,
	BUTTON_WIDTH,
	BUTTON_HEIGHT,
	buttonColor,
	buttonTextColor,
...
Button RNLButton(
	"RNL",
	BUTTON_WIDTH / 2,
	WINDOW_HEIGHT - BUTTON_TOP_MARGIN - BUTTON_HEIGHT - 360,
	BUTTON_WIDTH,
	BUTTON_HEIGHT,
	buttonColor,
	buttonTextColor,
...
Button AVLButton(
	"AVL",
	BUTTON_WIDTH / 2,
	WINDOW_HEIGHT - BUTTON_TOP_MARGIN - BUTTON_HEIGHT - 420,
	BUTTON_WIDTH,
	BUTTON_HEIGHT,
	buttonColor,
	buttonTextColor,
...
void Button::buttonClicked() {
	...
	if (name == "ADD") {
		...
		if (addModal.inputText != "") {
			...
			//l = tree.returnCount();
			AddToArray(tree.returnVal(), arr1, 0);
			//r = tree.returnVal();
			for (int i = 0; i < tree.returnCount(); i++) {
				//cout << arr[i] << endl;
		...
		if (deleteModal.inputText != "") {
			...
			AddToArray(tree.returnVal(), arr2, 0);
			for (int i = 0; i < tree.returnCount(); i++) {
				//cout << arr2[i] << endl;
...
void mouse(int button, int state, int x, int y) {
	...
	if (button == GLUT_LEFT_BUTTON && state == GLUT_UP) {
		...
		NLRButton.checkForMouseClick(x, y);
		NRLButton.checkForMouseClick(x, y);
		RNLButton.checkForMouseClick(x, y);
		RLNButton.checkForMouseClick(x, y);
		LNRButton.checkForMouseClick(x, y);
		LRNButton.checkForMouseClick(x, y);
		AVLButton.checkForMouseClick(x, y);
